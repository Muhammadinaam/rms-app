...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__reports_collection_report_collection_report_component__ = __webpack_require__("./src/app/reports/collection-report/collection-report.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__reports_sales_by_item_report_sales_by_item_report_component__ = __webpack_require__("./src/app/reports/sales-by-item-report/sales-by-item-report.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__reports_sales_by_order_report_sales_by_order_report_component__ = __webpack_require__("./src/app/reports/sales-by-order-report/sales-by-order-report.component.ts");
...
var routes = [
    { path: 'login', component: __WEBPACK_IMPORTED_MODULE_2__login_login_component__["a" /* LoginComponent */] },
    {
        ...
        children: [
            { path: 'change-password', component: __WEBPACK_IMPORTED_MODULE_15__change_password_change_password_component__["a" /* ChangePasswordComponent */] },
            ...
            { path: 'sales-by-item-report', component: __WEBPACK_IMPORTED_MODULE_16__reports_sales_by_item_report_sales_by_item_report_component__["a" /* SalesByItemReportComponent */] },
            { path: 'sales-by-order-report', component: __WEBPACK_IMPORTED_MODULE_17__reports_sales_by_order_report_sales_by_order_report_component__["a" /* SalesByOrderReportComponent */] },
            { path: 'edits-after-print-report', component: __WEBPACK_IMPORTED_MODULE_18__reports_edits_after_print_edits_after_print_component__["a" /* EditsAfterPrintComponent */] },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_60__reports_items_list_dialog_items_list_dialog_component__ = __webpack_require__("./src/app/reports/items-list-dialog/items-list-dialog.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_60__reports_items_list_dialog_items_list_dialog_component__["a" /* ItemsListDialogComponent */],
            ],
            imports: [
...
var ChangePasswordComponent = /** @class */ (function () {
    ...
    ChangePasswordComponent.prototype.onSubmit = function (form_data) {
        this.authService.changePassword(form_data.old_password, form_data.new_password)
            .subscribe(function (data) { alert(data['message']); });
    };
...
/***/ "./src/app/dates-filter/dates-filter.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DatesFilterComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var DatesFilterComponent = /** @class */ (function () {
    function DatesFilterComponent() {
        this.show_actual = false;
        this.hidden_checkbox_available = true;
        this.onShowBtnClicked = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
    }
    DatesFilterComponent.prototype.ngOnInit = function () {
    };
    DatesFilterComponent.prototype.onClicked = function () {
    ...
    ], DatesFilterComponent.prototype, "hidden_checkbox_available", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"])(),
        __metadata("design:type", Object)
    ], DatesFilterComponent.prototype, "onShowBtnClicked", void 0);
    DatesFilterComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-dates-filter',
            template: __webpack_require__("./src/app/dates-filter/dates-filter.component.html"),
            styles: [__webpack_require__("./src/app/dates-filter/dates-filter.component.css")]
        }),
        __metadata("design:paramtypes", [])
    ], DatesFilterComponent);
    return DatesFilterComponent;
}());
...
/***/ "./src/app/invoices-printing/invoices-printing.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return InvoicesPrintingComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common_http__ = __webpack_require__("./node_modules/@angular/common/esm5/http.js");
...
var InvoicesPrintingComponent = /** @class */ (function () {
    function InvoicesPrintingComponent(http, config) {
        this.http = http;
        this.config = config;
    }
    InvoicesPrintingComponent.prototype.ngOnInit = function () {
    };
    InvoicesPrintingComponent.prototype.printBtnClicked = function () {
    ...
    InvoicesPrintingComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
...
var OpenOrderComponent = /** @class */ (function () {
    ...
    OpenOrderComponent.prototype.showDiscountModal = function () {
        this.is_discount_modal_visible = true;
    };
    OpenOrderComponent.prototype.onModalShow = function (event) {
        this.modalOpen.emit();
    };
    OpenOrderComponent.prototype.changeStatus = function (order_id, status, user_id, password, remarks) {
        var _this = this;
        var r = confirm("Are you sure?");
        if (r != true) {
            return;
    ...
    OpenOrderComponent.prototype.closeOrder = function (order_id, received_through, ent_remarks) {
        var _this = this;
        var r = confirm('Are you Sure?');
        if (r != true)
            return;
    ...
    OpenOrderComponent.prototype.discountPercentBlur = function (event) {
        var discount_percent = event.target.value;
        this.order.discount = this.order.order_amount_before_discount * discount_percent / 100;
        this.calculateOrderAmounts();
    };
    OpenOrderComponent.prototype.discountAmountBlur = function (event) {
        this.order.discount = event.target.value;
        this.calculateOrderAmounts();
    };
    OpenOrderComponent.prototype.calculateOrderAmounts = function () {
        var sales_tax_rate = this.order.sales_tax / this.order.order_amount_ex_st * 100;
    ...
    OpenOrderComponent.prototype.saveDiscount = function () {
        var _this = this;
        ...
        this.ordersService.saveDiscount(this.order, this.other_info)
            ...
            alert(data['message']);
            if (data['success'] == true) {
                _this.is_discount_modal_visible = false;
            }
        });
    };
    __decorate([
...
var OrderComponent = /** @class */ (function () {
    ...
    OrderComponent.prototype.ngOnInit = function () {
        ...
        this.itemsService.getItems()
            .subscribe(function (data) {
            _this.items = data;
            _this.items.splice(0, 0, _this.new_item);
            _this.is_loading = false;
        });
        this.is_loading = true;
    ...
    OrderComponent.prototype.decreaseNewQty = function () {
        this.new_item.qty--;
        if (this.new_item.qty < 0) {
            this.new_item.qty = 0;
        }
    };
    OrderComponent.prototype.increaseNewQty = function () {
        this.new_item.qty++;
    };
...
/***/ "./src/app/reports/cancelled-orders-report/cancelled-orders-report.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CancelledOrdersReportComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
...
var CancelledOrdersReportComponent = /** @class */ (function () {
    function CancelledOrdersReportComponent(reportsService, orderService) {
        this.reportsService = reportsService;
        this.orderService = orderService;
        this.is_order_modal_visible = false;
        this.order_data = {
            order_details: [],
        };
    }
    CancelledOrdersReportComponent.prototype.ngOnInit = function () {
    };
    CancelledOrdersReportComponent.prototype.showReport = function (event) {
        var _this = this;
    ...
    CancelledOrdersReportComponent.prototype.showOrder = function (order_id) {
        var _this = this;
        this.order_data.order_details = [];
        this.is_order_modal_visible = true;
        this.orderService.getOrderById(order_id)
            .subscribe(function (data) {
            data['order_details'].forEach(function (order_detail) {
                _this.order_data.order_details.push({
    ...
    CancelledOrdersReportComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-cancelled-orders-report',
            template: __webpack_require__("./src/app/reports/cancelled-orders-report/cancelled-orders-report.component.html"),
            styles: [__webpack_require__("./src/app/reports/cancelled-orders-report/cancelled-orders-report.component.css")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_reports_service__["a" /* ReportsService */], __WEBPACK_IMPORTED_MODULE_2__services_orders_service__["a" /* OrdersService */]])
    ], CancelledOrdersReportComponent);
    return CancelledOrdersReportComponent;
}());
...
/***/ "./src/app/reports/edits-after-print/edits-after-print.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return EditsAfterPrintComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_reports_service__ = __webpack_require__("./src/app/services/reports.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_orders_service__ = __webpack_require__("./src/app/services/orders.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
...
var EditsAfterPrintComponent = /** @class */ (function () {
    function EditsAfterPrintComponent(reportsService, ordersService) {
        this.reportsService = reportsService;
        this.ordersService = ordersService;
        this.is_edit_detail_modal_visible = false;
        this.edit_data = {
            edit_details: [],
        };
    }
    EditsAfterPrintComponent.prototype.ngOnInit = function () {
    };
    EditsAfterPrintComponent.prototype.showReport = function (event) {
        var _this = this;
    ...
    EditsAfterPrintComponent.prototype.showEditDetail = function (to_edit_id) {
        var _this = this;
        this.edit_data.edit_details = [];
        this.is_edit_detail_modal_visible = true;
        this.ordersService.getOrderEditById(to_edit_id)
            .subscribe(function (data) {
            data['to_edit_details'].forEach(function (edit_detail) {
                _this.edit_data.edit_details.push({
    ...
    EditsAfterPrintComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-edits-after-print',
            template: __webpack_require__("./src/app/reports/edits-after-print/edits-after-print.component.html"),
            styles: [__webpack_require__("./src/app/reports/edits-after-print/edits-after-print.component.css")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_reports_service__["a" /* ReportsService */], __WEBPACK_IMPORTED_MODULE_2__services_orders_service__["a" /* OrdersService */]])
    ], EditsAfterPrintComponent);
    return EditsAfterPrintComponent;
}());
...
module.exports = "<p-dialog header=\"Detail\" [modal]=\"true\" [(visible)]=\"dialogVisibility\">\n    <h4>Items</h4>\n    \n    <table class=\"table table-bordered table-condensed table-hover\">\n        <thead>\n            <tr>\n                <th>Item</th>\n                <th>Qty</th>\n                <th>Rate</th>\n                <th>Amount</th>\n                <th *ngIf=\"show_action_columns\">Action</th>\n            </tr>\n        </thead>\n        <tbody>\n            <tr *ngFor=\"let row of items_detail\">\n                <td>{{row.item_name}}</td>\n                <td>{{row.qty | currency:' '}}</td>\n                <td>{{row.rate | currency:' '}}</td>\n                <td>{{row.amount | currency:' '}}</td>\n                <td *ngIf=\"show_action_columns\">{{row.action}}</td>\n            </tr>\n        </tbody>\n    </table>\n    \n</p-dialog>\n"

/***/ }),

/***/ "./src/app/reports/items-list-dialog/items-list-dialog.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ItemsListDialogComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var ItemsListDialogComponent = /** @class */ (function () {
    function ItemsListDialogComponent() {
        this.dialogVisibilityChange = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
    }
    ItemsListDialogComponent.prototype.ngOnInit = function () {
    };
    Object.defineProperty(ItemsListDialogComponent.prototype, "dialogVisibility", {
        get: function () {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"])(),
        __metadata("design:type", Object)
    ], ItemsListDialogComponent.prototype, "dialogVisibilityChange", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [Object])
    ], ItemsListDialogComponent.prototype, "dialogVisibility", null);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Object)
    ], ItemsListDialogComponent.prototype, "items_detail", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Object)
    ], ItemsListDialogComponent.prototype, "show_action_columns", void 0);
    ItemsListDialogComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-items-list-dialog',
            template: __webpack_require__("./src/app/reports/items-list-dialog/items-list-dialog.component.html"),
            styles: [__webpack_require__("./src/app/reports/items-list-dialog/items-list-dialog.component.css")]
        }),
        __metadata("design:paramtypes", [])
    ], ItemsListDialogComponent);
    return ItemsListDialogComponent;
}());
...
var RatingAddEditComponent = /** @class */ (function () {
    function RatingAddEditComponent(http, config) {
        this.http = http;
        this.config = config;
        this.order_id = '';
        this.food_rating = '';
    ...
    RatingAddEditComponent.prototype.saveRating = function () {
        var fd = new FormData();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("./node_modules/@angular/router/esm5/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_reports_service__ = __webpack_require__("./src/app/services/reports.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var RatingReportComponent = /** @class */ (function () {
    function RatingReportComponent(router, reportsService) {
        this.router = router;
        this.reportsService = reportsService;
    }
    RatingReportComponent.prototype.ngOnInit = function () {
    };
    RatingReportComponent.prototype.showReport = function (event) {
        var _this = this;
    ...
    RatingReportComponent.prototype.showRatingAddEditForm = function () {
    ...
    RatingReportComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_router__["Router"], __WEBPACK_IMPORTED_MODULE_2__services_reports_service__["a" /* ReportsService */]])
...
/***/ "./src/app/reports/sales-by-item-report/sales-by-item-report.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SalesByItemReportComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_reports_service__ = __webpack_require__("./src/app/services/reports.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var SalesByItemReportComponent = /** @class */ (function () {
    function SalesByItemReportComponent(reportsService) {
        this.reportsService = reportsService;
    ...
    SalesByItemReportComponent.prototype.ngOnInit = function () {
    };
    SalesByItemReportComponent.prototype.showReport = function (event) {
        var _this = this;
    ...
    SalesByItemReportComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-sales-by-item-report',
            template: __webpack_require__("./src/app/reports/sales-by-item-report/sales-by-item-report.component.html"),
            styles: [__webpack_require__("./src/app/reports/sales-by-item-report/sales-by-item-report.component.css")]
        }),
    ...
    return SalesByItemReportComponent;
}());
...
/***/ "./src/app/reports/sales-by-order-report/sales-by-order-report.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SalesByOrderReportComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_reports_service__ = __webpack_require__("./src/app/services/reports.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var SalesByOrderReportComponent = /** @class */ (function () {
    function SalesByOrderReportComponent(reportsService) {
        this.reportsService = reportsService;
        this.ent_report_data = new Array();
        this.report_summary = {
            'receipt_detail': [],
        ...
        this.is_invoice_modal_visible = false;
        this.is_actual = false;
        this.invoice_data = {
            'invoice_details': [],
        };
    }
    SalesByOrderReportComponent.prototype.ngOnInit = function () {
    };
    SalesByOrderReportComponent.prototype.showReport = function (event) {
        var _this = this;
    ...
    SalesByOrderReportComponent.prototype.showInvoice = function (invoice_id, invoice_datetime) {
        var _this = this;
        ...
        this.reportsService.getInvoiceData(invoice_id, invoice_datetime, this.is_actual)
            .subscribe(function (data) {
            _this.invoice_data.invoice_details = data;
            console.log(_this.invoice_data);
        });
    };
    SalesByOrderReportComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-sales-by-order-report',
            template: __webpack_require__("./src/app/reports/sales-by-order-report/sales-by-order-report.component.html"),
            styles: [__webpack_require__("./src/app/reports/sales-by-order-report/sales-by-order-report.component.css")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_reports_service__["a" /* ReportsService */]])
    ], SalesByOrderReportComponent);
    return SalesByOrderReportComponent;
}());
...
/***/ "./src/app/reports/summary/summary.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var SummaryComponent = /** @class */ (function () {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(),
        __metadata("design:type", Object)
    ], SummaryComponent.prototype, "report_summary", void 0);
    SummaryComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-summary',
            template: __webpack_require__("./src/app/reports/summary/summary.component.html"),
            styles: [__webpack_require__("./src/app/reports/summary/summary.component.css")]
        }),
        __metadata("design:paramtypes", [])
    ], SummaryComponent);
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.changePassword = function (old_password, new_password) {
        var fd = new FormData();
...
var HelperService = /** @class */ (function () {
    ...
    HelperService.prototype.toSqlFormat = function (date, format) {
...
var ItemsService = /** @class */ (function () {
    ...
    ItemsService.prototype.getItems = function (show_inactive_also) {
        if (show_inactive_also === void 0) { show_inactive_also = 0; }
        var url = '/api/items';
...
var OrdersService = /** @class */ (function () {
    ...
    OrdersService.prototype.getOrderEditById = function (id) {
    ...
    OrdersService.prototype.saveOrder = function (order, deleted_details, id, other_info) {
        var fd = new FormData();
    ...
    OrdersService.prototype.saveDiscount = function (order, other_info) {
        var fd = new FormData();
        fd.append('order', JSON.stringify(order));
        fd.append('other_info', JSON.stringify(other_info));
    ...
    OrdersService.prototype.changeOrderStatus = function (order_id, status, user_id, password, remarks) {
        var data = new FormData();
    ...
    OrdersService.prototype.closeOrder = function (order_id, received_through, ent_remarks) {
        var data = new FormData();
        data.append('order_id', order_id);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__config_service__ = __webpack_require__("./src/app/services/config.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_common_http__ = __webpack_require__("./node_modules/@angular/common/esm5/http.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__helper_service__ = __webpack_require__("./src/app/services/helper.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ReportsService = /** @class */ (function () {
    function ReportsService(config, http, h) {
        this.config = config;
        this.http = http;
        this.h = h;
    }
    ...
    ReportsService.prototype.ratingsReport = function (from_date, to_date, show_actual) {
    ...
    ReportsService.prototype.getInvoiceData = function (invoice_id, invoice_datetime, show_actual) {
        var params = {
    ...
    ReportsService.prototype.collectionReport = function (from_date, to_date, show_actual) {
        var params = {
            'from_date': this.h.toSqlFormat(from_date),
            'to_date': this.h.toSqlFormat(to_date),
            's_a': show_actual,
